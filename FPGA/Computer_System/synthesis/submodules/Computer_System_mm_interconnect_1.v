...
module Computer_System_mm_interconnect_1 (
	...
	wire  [116:0] init_x_s1_agent_rf_source_data;                                              // init_x_s1_agent:rf_source_data -> init_x_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] init_x_s1_agent_rsp_fifo_out_data;                                           // init_x_s1_agent_rsp_fifo:out_data -> init_x_s1_agent:rf_sink_data
	...
	wire  [116:0] step_s1_agent_rf_source_data;                                                // step_s1_agent:rf_source_data -> step_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] step_s1_agent_rsp_fifo_out_data;                                             // step_s1_agent_rsp_fifo:out_data -> step_s1_agent:rf_sink_data
	...
	wire  [116:0] init_y_s1_agent_rf_source_data;                                              // init_y_s1_agent:rf_source_data -> init_y_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] init_y_s1_agent_rsp_fifo_out_data;                                           // init_y_s1_agent_rsp_fifo:out_data -> init_y_s1_agent:rf_sink_data
	...
	wire  [116:0] num_iter_s1_agent_rf_source_data;                                            // num_iter_s1_agent:rf_source_data -> num_iter_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] num_iter_s1_agent_rsp_fifo_out_data;                                         // num_iter_s1_agent_rsp_fifo:out_data -> num_iter_s1_agent:rf_sink_data
	...
	wire  [116:0] frame_ms_s1_agent_rf_source_data;                                            // frame_ms_s1_agent:rf_source_data -> frame_ms_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] frame_ms_s1_agent_rsp_fifo_out_data;                                         // frame_ms_s1_agent_rsp_fifo:out_data -> frame_ms_s1_agent:rf_sink_data
	...
	wire  [115:0] init_x_s1_agent_rp_data;                                                     // init_x_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [115:0] step_s1_agent_rp_data;                                                       // step_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] init_y_s1_agent_rp_data;                                                     // init_y_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] num_iter_s1_agent_rp_data;                                                   // num_iter_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] frame_ms_s1_agent_rp_data;                                                   // frame_ms_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [115:0] pixel_dma_addr_translation_slave_agent_rp_data;                              // Pixel_DMA_Addr_Translation_slave_agent:rp_data -> router_009:sink_data
	...
	wire  [115:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> init_x_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                       // init_x_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> init_x_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] init_x_s1_burst_adapter_source0_data;                                        // init_x_s1_burst_adapter:source0_data -> init_x_s1_agent:cp_data
	wire          init_x_s1_burst_adapter_source0_ready;                                       // init_x_s1_agent:cp_ready -> init_x_s1_burst_adapter:source0_ready
	wire    [7:0] init_x_s1_burst_adapter_source0_channel;                                     // init_x_s1_burst_adapter:source0_channel -> init_x_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> step_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                       // step_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> step_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] step_s1_burst_adapter_source0_data;                                          // step_s1_burst_adapter:source0_data -> step_s1_agent:cp_data
	wire          step_s1_burst_adapter_source0_ready;                                         // step_s1_agent:cp_ready -> step_s1_burst_adapter:source0_ready
	wire    [7:0] step_s1_burst_adapter_source0_channel;                                       // step_s1_burst_adapter:source0_channel -> step_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> init_y_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                       // init_y_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> init_y_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] init_y_s1_burst_adapter_source0_data;                                        // init_y_s1_burst_adapter:source0_data -> init_y_s1_agent:cp_data
	wire          init_y_s1_burst_adapter_source0_ready;                                       // init_y_s1_agent:cp_ready -> init_y_s1_burst_adapter:source0_ready
	wire    [7:0] init_y_s1_burst_adapter_source0_channel;                                     // init_y_s1_burst_adapter:source0_channel -> init_y_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> num_iter_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                       // num_iter_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> num_iter_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] num_iter_s1_burst_adapter_source0_data;                                      // num_iter_s1_burst_adapter:source0_data -> num_iter_s1_agent:cp_data
	wire          num_iter_s1_burst_adapter_source0_ready;                                     // num_iter_s1_agent:cp_ready -> num_iter_s1_burst_adapter:source0_ready
	wire    [7:0] num_iter_s1_burst_adapter_source0_channel;                                   // num_iter_s1_burst_adapter:source0_channel -> num_iter_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> frame_ms_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                       // frame_ms_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> frame_ms_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] frame_ms_s1_burst_adapter_source0_data;                                      // frame_ms_s1_burst_adapter:source0_data -> frame_ms_s1_agent:cp_data
	wire          frame_ms_s1_burst_adapter_source0_ready;                                     // frame_ms_s1_agent:cp_ready -> frame_ms_s1_burst_adapter:source0_ready
	wire    [7:0] frame_ms_s1_burst_adapter_source0_channel;                                   // frame_ms_s1_burst_adapter:source0_channel -> frame_ms_s1_agent:cp_channel
	...
	wire          cmd_mux_007_src_valid;                                                       // cmd_mux_007:src_valid -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                       // Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                               // cmd_mux_007:src_startofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                 // cmd_mux_007:src_endofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                 // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] pixel_dma_addr_translation_slave_agent_rdata_fifo_out_data;                  // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                 // avalon_st_adapter_007:in_0_ready -> Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                                           // avalon_st_adapter_007:out_0_valid -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                            // avalon_st_adapter_007:out_0_data -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                           // Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                           // avalon_st_adapter_007:out_0_error -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_error
