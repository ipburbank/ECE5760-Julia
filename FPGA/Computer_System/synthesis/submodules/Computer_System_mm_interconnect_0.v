...
module Computer_System_mm_interconnect_0 (
	...
	wire   [99:0] rsp_mux_002_src_data;                                                              // rsp_mux_002:src_data -> VGA_Subsystem_pixel_dma_master_agent:rp_data
	...
	wire  [100:0] vga_subsystem_char_buffer_slave_agent_rf_source_data;                              // VGA_Subsystem_char_buffer_slave_agent:rf_source_data -> VGA_Subsystem_char_buffer_slave_agent_rsp_fifo:in_data
	...
	wire  [100:0] vga_subsystem_char_buffer_slave_agent_rsp_fifo_out_data;                           // VGA_Subsystem_char_buffer_slave_agent_rsp_fifo:out_data -> VGA_Subsystem_char_buffer_slave_agent:rf_sink_data
	...
	wire  [100:0] onchip_vga_buffer_s2_agent_rf_source_data;                                         // onchip_vga_buffer_s2_agent:rf_source_data -> onchip_vga_buffer_s2_agent_rsp_fifo:in_data
	...
	wire  [100:0] onchip_vga_buffer_s2_agent_rsp_fifo_out_data;                                      // onchip_vga_buffer_s2_agent_rsp_fifo:out_data -> onchip_vga_buffer_s2_agent:rf_sink_data
	...
	wire   [99:0] vga_subsystem_pixel_dma_master_agent_cp_data;                                      // VGA_Subsystem_pixel_dma_master_agent:cp_data -> router_002:sink_data
	...
	wire   [99:0] vga_subsystem_char_buffer_slave_agent_rp_data;                                     // VGA_Subsystem_char_buffer_slave_agent:rp_data -> router_003:sink_data
	...
	wire          onchip_vga_buffer_s2_agent_rp_valid;                                               // onchip_vga_buffer_s2_agent:rp_valid -> router_004:sink_valid
	wire   [99:0] onchip_vga_buffer_s2_agent_rp_data;                                                // onchip_vga_buffer_s2_agent:rp_data -> router_004:sink_data
	wire          onchip_vga_buffer_s2_agent_rp_ready;                                               // router_004:sink_ready -> onchip_vga_buffer_s2_agent:rp_ready
	wire          onchip_vga_buffer_s2_agent_rp_startofpacket;                                       // onchip_vga_buffer_s2_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          onchip_vga_buffer_s2_agent_rp_endofpacket;                                         // onchip_vga_buffer_s2_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire   [99:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> VGA_Subsystem_char_buffer_slave_burst_adapter:sink0_data
	...
	wire   [99:0] vga_subsystem_char_buffer_slave_burst_adapter_source0_data;                        // VGA_Subsystem_char_buffer_slave_burst_adapter:source0_data -> VGA_Subsystem_char_buffer_slave_agent:cp_data
	...
	wire          cmd_mux_001_src_valid;                                                             // cmd_mux_001:src_valid -> onchip_vga_buffer_s2_burst_adapter:sink0_valid
	wire   [99:0] cmd_mux_001_src_data;                                                              // cmd_mux_001:src_data -> onchip_vga_buffer_s2_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                             // onchip_vga_buffer_s2_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                                           // cmd_mux_001:src_channel -> onchip_vga_buffer_s2_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                                     // cmd_mux_001:src_startofpacket -> onchip_vga_buffer_s2_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                       // cmd_mux_001:src_endofpacket -> onchip_vga_buffer_s2_burst_adapter:sink0_endofpacket
	...
	wire   [99:0] onchip_vga_buffer_s2_burst_adapter_source0_data;                                   // onchip_vga_buffer_s2_burst_adapter:source0_data -> onchip_vga_buffer_s2_agent:cp_data
	...
	wire   [99:0] cmd_demux_002_src0_data;                                                           // cmd_demux_002:src0_data -> cmd_mux_001:sink2_data
	...
	wire   [99:0] rsp_demux_001_src2_data;                                                           // rsp_demux_001:src2_data -> rsp_mux_002:sink0_data
	...
	wire  [234:0] arm_a9_hps_h2f_axi_master_wr_limiter_cmd_src_data;                                 // ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_src_data -> ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:in_data
	...
	wire    [2:0] arm_a9_hps_h2f_axi_master_wr_limiter_cmd_src_channel;                              // ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_src_channel -> ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:in_channel
	...
	wire   [99:0] arm_a9_hps_h2f_axi_master_wr_cmd_width_adapter_src_data;                           // ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:out_data -> cmd_demux:sink_data
	...
	wire    [2:0] arm_a9_hps_h2f_axi_master_wr_cmd_width_adapter_src_channel;                        // ARM_A9_HPS_h2f_axi_master_wr_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	...
	wire   [99:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                                 // ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [2:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:in_channel
	...
	wire  [234:0] arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_data;                           // ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_data -> ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire    [2:0] arm_a9_hps_h2f_axi_master_wr_rsp_width_adapter_src_channel;                        // ARM_A9_HPS_h2f_axi_master_wr_rsp_width_adapter:out_channel -> ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_sink_channel
	...
	wire  [234:0] arm_a9_hps_h2f_axi_master_rd_limiter_cmd_src_data;                                 // ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_src_data -> ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:in_data
	...
	wire    [2:0] arm_a9_hps_h2f_axi_master_rd_limiter_cmd_src_channel;                              // ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_src_channel -> ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:in_channel
	...
	wire   [99:0] arm_a9_hps_h2f_axi_master_rd_cmd_width_adapter_src_data;                           // ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:out_data -> cmd_demux_001:sink_data
	...
	wire    [2:0] arm_a9_hps_h2f_axi_master_rd_cmd_width_adapter_src_channel;                        // ARM_A9_HPS_h2f_axi_master_rd_cmd_width_adapter:out_channel -> cmd_demux_001:sink_channel
	...
	wire   [99:0] rsp_mux_001_src_data;                                                              // rsp_mux_001:src_data -> ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_data
	wire          rsp_mux_001_src_ready;                                                             // ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                                           // rsp_mux_001:src_channel -> ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:in_channel
	...
	wire  [234:0] arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_data;                           // ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_data -> ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire    [2:0] arm_a9_hps_h2f_axi_master_rd_rsp_width_adapter_src_channel;                        // ARM_A9_HPS_h2f_axi_master_rd_rsp_width_adapter:out_channel -> ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_sink_channel
	...
	wire          onchip_vga_buffer_s2_agent_rdata_fifo_out_valid;                                   // onchip_vga_buffer_s2_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire    [9:0] onchip_vga_buffer_s2_agent_rdata_fifo_out_data;                                    // onchip_vga_buffer_s2_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          onchip_vga_buffer_s2_agent_rdata_fifo_out_ready;                                   // avalon_st_adapter_001:in_0_ready -> onchip_vga_buffer_s2_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                 // avalon_st_adapter_001:out_0_valid -> onchip_vga_buffer_s2_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_001_out_0_data;                                                  // avalon_st_adapter_001:out_0_data -> onchip_vga_buffer_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                 // onchip_vga_buffer_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                 // avalon_st_adapter_001:out_0_error -> onchip_vga_buffer_s2_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_agent #(
		...
		.clk                   (System_PLL_sys_clk_clk),                                                            //       clk.clk
		.reset                 (onchip_vga_buffer_reset2_reset_bridge_in_reset_reset),                              // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (onchip_vga_buffer_reset2_reset_bridge_in_reset_reset),                // cr0_reset.reset
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (onchip_vga_buffer_reset2_reset_bridge_in_reset_reset),       // in_rst_0.reset
